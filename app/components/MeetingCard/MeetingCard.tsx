...
export function MeetingCard({ meeting, onDelete }: MeetingCardProps) {
  ...
  return (
    <Box>
      ...
      <Typography variant="body1">Start: {moment(meeting.timeToStart).format('YYYY-MM-DD hh:mm A')} </Typography>
      <Typography variant="body1">End: {moment(meeting.timeToEnd).format('YYYY-MM-DD hh:mm A')} </Typography>
